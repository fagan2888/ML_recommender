...
%% second neural for test
fprintf('Training another simple neural network..\n');
rng(8339);  % fix seed, this    NN is very sensitive to initialization
net = patternnet([3 3 3]);
...
%% neural 5
fprintf('Training neural 5...\n');
rng(8339);  % fix seed, this    NN is very sensitive to initialization
net = patternnet([5 4 3 2]);
...
methodNames = {'Neural basic','neural 2', 'neural 3', 'neural 4', 'neural 5', 'Random'}; % this is to show it in the legend
avgTPRList = evaluateMultipleMethods( Te.y > 0, [nnPred, nnPred2, nnPred3, nnPred4, nnPred5, randPred], true, methodNames );
